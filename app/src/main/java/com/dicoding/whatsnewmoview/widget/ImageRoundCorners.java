...
public class ImageRoundCorners extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public ImageRoundCorners(Context context, AttributeSet attrs) {
